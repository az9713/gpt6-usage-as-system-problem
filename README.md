...
Open the [live Codex Usage as a Systems Problem field guide](https://az9713.github.io/gpt-6-usage/gpt-6-usage.html) for the complete standalone dark-mode report. The repository also contains the portable [HTML source](gpt-6-usage.html).
